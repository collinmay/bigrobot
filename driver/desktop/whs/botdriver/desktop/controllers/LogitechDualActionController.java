...
public class LogitechDualActionController extends WController {
	...
	public LogitechDualActionController(Controller c) {
		super(c);
		
		this.leftStick = new DualAxisJoystick("Left Joystick", Component.Identifier.Axis.X, Component.Identifier.Axis.Y);
		this.rightStick = new DualAxisJoystick("Right Joystick", Component.Identifier.Axis.Z, Component.Identifier.Axis.RZ);
